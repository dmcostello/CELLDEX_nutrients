...
plot(Nim+1~DIN,data=CNPk_STR_WQ,log="xy",xlab="",xlim=c(1,3000),xaxt="n", ylim=c(1,2000),yaxt="n",ylab=expression("N"[IMM]*"+1 (µg N/g C/d)"),col=siteS_bcol,pch=16)
logaxis(0,3,1)
logaxis(0,3,2)
...
par(mar=c(3,3,1,1))
plot(Pim+1~PO4_ugL,data=CNPk_STR_WQ,log="xy",xlab="", ylab=expression("P"[IMM]*"+1 (µg P/g C/d)"),xlim=c(0.1,1000),xaxt="n",ylim=c(1,1000),yaxt="n",col=siteS_bcol,pch=16)
logaxis(0,3,2)
logaxis(0,3,1)
logaxis(-1,-0.1,1)
...
plot(resid~eval(Nim+1),data=CNPk_STR,log="x",ylim=c(-3,3),xlim=c(1,2000),xaxt="n",xlab=expression("N"[IMM]*" +1 (µg N/g C/d)"),ylab="Deviation in ln(k)",col=siteS_bcol,las=1,pch=16)
...
plot(resid~eval(Pim+1),data=CNPk_STR,log="x",col=siteS_bcol,ylim=c(-3,3),xlim=c(1,1000),xaxt="n",xlab=expression("P"[IMM]*"+1 (µg P/g C/d)"),ylab="",yaxt="n",pch=16)
...
par(mar=c(4,7,0,1))
with(eco[eco$Study=="CELLDEX"&eco$Habitat=="stream",],plot(rep(1,11)~N_instant,ylim=c(0,8),xlim=c(.1,1000),log="x",col=ecocol,yaxt="n",ylab="",cex=2,lwd=2,xlab=expression("Instantaneous N flux (mg N/m"^2*"/d)"),xaxt="n"))
logaxis(0,3,1)
logaxis(-1,-.1,1)

#Convert values from Ensign and Doyle 2006 from ug/m2/min to mg/m2/d
NO3ensign <- c(0,5.2,14.5,66.3,1000)*1440/1000
NH4ensign <- c(0,2.2,5.1,10.4,1000)*1440/1000

#Convert Marcarelli values from ug/m2/h to mg/m2/d
Nfix <- c(0,4,9,410,1000)*24/1000

NO3bx=list(stats=data.matrix(NO3ensign),n=1)
...
#Instantaneous flux panel
par(mar=c(4,7,0,1))
with(eco[eco$Study=="CELLDEX"&eco$Habitat=="stream",],plot(rep(1,11)~P_instant,ylim=c(0,8),xlim=c(.1,100),log="x",col=ecocol,yaxt="n",ylab="",cex=2,lwd=2,xlab=expression("Instantaneous P flux (mg P/m"^2*"/d)"),xaxt="n"))
logaxis(0,2,1)
logaxis(-1,-.1,1)

#Convert values from Ensign and Doyle 2006 from ug/m2/min to mg/m2/d
PO4ensign <- c(0,6.2,13.7,34.6,1000)*1440/1000
